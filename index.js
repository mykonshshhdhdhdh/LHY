...
var blackC = document.getElementById('blackC');blackC.style.transition = "0s"; blackC.style.display = "none";
var blackD = document.getElementById('blackD');blackD.style.transition = "0s"; blackD.style.display = "none";
}
function blackB(){
document.body.style.overflow = 'hidden';
var black = document.getElementById('black');black.style.transition = "0s"; black.style.display = "inline";
...
var blackA = document.getElementById('blackA');blackA.style.transition = "0s"; blackA.style.display = "none";
var blackB = document.getElementById('blackB');blackB.style.transition = "0s"; blackB.style.display = "none";
var blackC = document.getElementById('blackC');blackC.style.transition = "0s"; blackC.style.display = "inline";
var blackD = document.getElementById('blackD');blackD.style.transition = "0s"; blackD.style.display = "none";
}
function blackD(){
document.body.style.overflow = 'hidden';
...
var blackB = document.getElementById('blackB');blackB.style.transition = "0s"; blackB.style.display = "none";
var blackC = document.getElementById('blackC');blackC.style.transition = "0s"; blackC.style.display = "none";
var blackD = document.getElementById('blackD');blackD.style.transition = "0s"; blackD.style.display = "inline";
}
